...
weight_decay = 0.0001
class_num    = 10
log_filepath = 'logs/cifar10/vgg19/10242/'
...
def main():
    ...
    model.save(log_filepath+'vgg19.h5')
    # model.save('ghost_vgg19.h5')

# vgg19 fc1:4096;fc2:4096
# Total params: 39,002,738
# Trainable params: 38,975,326
# Non-trainable params: 27,412

# vgg19 fc1:1024;fc2:1024
# Total params: 21,639,794
# Trainable params: 21,624,670
# Non-trainable params: 15,124

# ghost_vgg19 fc1:4096;fc2:4096
# Total params: 29,015,314
# Trainable params: 28,987,902
# Non-trainable params: 27,412

# ghost_vgg19 fc1:1024;fc2:1024
# Total params: 11,652,370
# Trainable params: 11,637,246
# Non-trainable params: 15,124
def _main():
    # model =vgg19(class_num)
    model = ghost_vgg19(class_num)
    model.summary()
