...
weight_decay = 0.0001
class_num    = 10
log_filepath = 'logs/cifar10/ghost_vgg16_v2/1024/'
...
def main():
    ...
    model.save(log_filepath+'ghost_vgg16_v2.h5')
...
# Total params: 16,324,978
# Trainable params: 16,312,414
...
# Total params: 8,986,642
# Trainable params: 8,974,078
# Non-trainable params: 12,564
def _main():
    # model =vgg16(class_num)
    model = ghost_vgg16(class_num)
